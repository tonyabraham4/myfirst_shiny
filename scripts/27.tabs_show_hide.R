...
# depending on whether the "Show data table" checkbox input was selected? We might want to 
# do something similar with the "Data" tab now. And we can achieve this using conditional tabs, via the showTab() and hideTab() functions.
