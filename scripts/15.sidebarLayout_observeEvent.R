...
# For example, if you only select "TV Movie", the maximum allowed sample size is 5, because there are only 5 TV movies in the sample. 
# We'll learn more about observeEvent() later in the course. For now, your task is simple: find the mismatched use of reactives.
