...
# The first argument in this function is the condition, which is a JavaScript expression that will 
# be evaluated repeatedly to determine whether the panel should be displayed.
